    ...
    def build_dining_room(self, board_pos):
        if board_pos[1] >= len(self.room_board):
            if board_pos[1] > len(self.room_board) + 1:
                ...
                self.room_board.append([DiningRoom(board_pos[0],board_pos[1],len(self.room_board))])
        else:
            self.room_board[board_pos[1]].append(DiningRoom(board_pos[0],board_pos[1],len(self.room_board)))
